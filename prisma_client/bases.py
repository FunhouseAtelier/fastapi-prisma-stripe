...
class BaseAssociate(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Associate']] = 'Associate'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.AssociateActions[_PrismaModelT]':
        from .client import get_client

        return actions.AssociateActions[_PrismaModelT](client or get_client(), cls)
...
class BaseLineItem(_PrismaModel):
    __prisma_model__: ClassVar[Literal['LineItem']] = 'LineItem'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.LineItemActions[_PrismaModelT]':
        from .client import get_client

        return actions.LineItemActions[_PrismaModelT](client or get_client(), cls)
